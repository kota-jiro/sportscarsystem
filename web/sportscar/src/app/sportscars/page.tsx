...
const sportscar = [
  {
    ...
    description: 'The Nissan Skyline R34 GT-R has a 2.6L twin-turbo inline-six with 276 hp, a 0-100 km/h time of 4.9 seconds, and a top speed of 250 km/h.',
    stack: [
      { name: 'AWD' }, { name: 'Car' }, { name: 'Car' },
    ],
    image: image1,
    live: '',
    car: '',
  },
  {
    ...
    brand: 'Porsche',
    model: '911 Carrera',
    description: 'The Porsche 911 Carrera has a 3.0L twin-turbo flat-six engine with 379 hp. It accelerates from 0 to 100 km/h in 4.2 seconds and has a top speed of 293 km/h.',
    stack: [
      { name: 'AWD' }, { name: 'Car' }, { name: 'Car' },
    ],
    image: image2,
  ...
  },
  {
    ...
    brand: 'McLaren',
    model: '720S',
    description: 'The McLaren 720S has a 4.0L twin-turbo V8 engine with 720 hp. It goes from 0 to 100 km/h in 2.9 seconds and has a top speed of 341 km/h.',
    stack: [
      { name: 'RWD' }, { name: 'Car' }, { name: 'Car' },
    ],
    image: image3,
    live: '',
    car: '',
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          <div className="w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none">
            <div className="flex flex-col gap-[30px] h-[50%]">
              ...
              {/* sports car brand */}
              <h2 className="text-[42px] font-bold leading-none text-white group-hover:text-accent transition-all duration-500 capitalize">{car.brand} car
              </h2>
